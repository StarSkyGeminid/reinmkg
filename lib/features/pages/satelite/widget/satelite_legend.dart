...
class SateliteLegend extends StatefulWidget {
  const SateliteLegend({super.key});

  @override
  SateliteLegendState createState() => SateliteLegendState();
}

class SateliteLegendState extends State<SateliteLegend>
