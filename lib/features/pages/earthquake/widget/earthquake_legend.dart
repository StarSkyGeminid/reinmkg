      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('${Strings.of(context).eqMagnitude} (SR)'),
            const SizedBox(height: 4),
            _buildMarkerSize(),
            const SizedBox(height: 8),
            Text(
                '${Strings.of(context).eqDepth} (${isMetric ? 'Km' : 'Miles'})'),
            const SizedBox(height: 4),
            _buildMarkerColor(),
          ],
        ),
    ...
    return Column(
      children: [
        Row(
          ...
          mainAxisSize: MainAxisSize.min,
          children:
              depth.take(2).map((e) => _buildDepthMarker(e, false)).toList(),
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          mainAxisSize: MainAxisSize.min,
