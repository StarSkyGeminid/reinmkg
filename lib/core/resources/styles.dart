      ...
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return Colors.white; // Warna saat ON
          }
          return Colors.grey[400]; // Warna saat OFF
        }),

        trackColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return Colors.blue; // Warna track saat ON
          }
          return Colors.grey[300]; // Warna track saat OFF
        }),

        // Warna outline track
        trackOutlineColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return Colors.transparent; // Hapus outline saat ON
          }
          return Colors.grey[400]; // Warna outline saat OFF
        }),

        // Opacity saat switch di-hover
...
class BoxShadows {
  ...
  BoxShadow get button => BoxShadow(
        color:
            Theme.of(context).extension<AppColors>()!.shadow!.withOpacity(0.5),
        blurRadius: 16.0,
        spreadRadius: 1.0,
      );
